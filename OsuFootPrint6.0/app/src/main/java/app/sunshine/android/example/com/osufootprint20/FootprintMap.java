...
public class
    ...
    private static final int NEW_FOOTPRINT = 3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newFootprintButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent_new_footprint.putExtra(NewFootprintFragment.DEFAULT_PLACE,(String)null);
                startActivityForResult(intent_new_footprint, NEW_FOOTPRINT);
            }
        });
