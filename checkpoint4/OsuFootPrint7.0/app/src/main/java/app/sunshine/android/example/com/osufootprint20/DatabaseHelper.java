...
//    }
    ...
    public void setPlaces(){
        ArrayList<MyPlace> place = new ArrayList<MyPlace>(Person.getPerson(context.getApplicationContext()).getMyPlace().getMySet());
        String name = Person.getPerson(context.getApplicationContext()).getName();
        Gson gson = new Gson();
        String place_string = gson.toJson(place,new TypeToken<ArrayList<MyPlace>>(){}.getType());
        ContentValues values = new ContentValues();
        values.put("place",place_string);
        db.update(TABLE_NAME,values,"name=?",new String[]{name});
    }
    ...
    public void getPlaces(){
        ...
        c.close();
        Gson gson=new Gson();
        ArrayList<MyPlace> place=gson.fromJson(place_string,new TypeToken<ArrayList<MyPlace>>(){}.getType());
        Person.getPerson(context.getApplicationContext()).getMyPlace().setMySet(place);
    }
